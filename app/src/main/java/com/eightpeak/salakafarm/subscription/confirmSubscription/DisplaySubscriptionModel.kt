...
////    @SerializedName("deliveryHistory") @Expose var deliveryHistory:  Map<String, DateList>?= null,
...
//
//data class DateList (
//    @SerializedName("delivery_count") val delivery_count : String,
//    @SerializedName("alter_status") val alter_status : String
//)
//
//
//data class Branch (
