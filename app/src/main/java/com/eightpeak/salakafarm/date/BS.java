...
public class BS extends Fragment implements OnItemSelectedListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View i = inflater.inflate(R.layout.fragment_b, container, false);
		t = (TextView) i.findViewById(R.id.text);
		spinner1 = (Spinner) i.findViewById(R.id.engspiner1);
		spinner2 = (Spinner) i.findViewById(R.id.engspinner2);
		spinner3 = (Spinner) i.findViewById(R.id.engspinner3);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		convert = (Button) getActivity().findViewById(R.id.convert);
	...
	@Override
	public void onItemSelected(AdapterView<?> arg0, View view, int p, long arg3) {
		// TODO Auto-generated method stub
		...
		num2 = 1 + spinner2.getSelectedItemPosition();
